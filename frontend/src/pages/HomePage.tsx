                ...
                <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center gap-2">
                            ...
                            <h1 className="text-2xl font-bold text-green-600">Kisan Sarathi</h1>
                        </div>
            ...
            <section className="max-w-7xl mx-auto px-4 py-20 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                        Kisan Sarathi brings farmers and buyers together on a single platform,
            ...
            <section className="bg-gradient-to-r from-green-600 to-blue-600 py-16">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-white mb-8">
                        Join thousands of farmers and buyers already using Kisan Sarathi
                    </p>
                    <Link
                        to="/register"
            ...
            <footer className="bg-gray-900 text-white py-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <p className="text-gray-400">
                        © 2024 Kisan Sarathi. All rights reserved.
                    </p>
